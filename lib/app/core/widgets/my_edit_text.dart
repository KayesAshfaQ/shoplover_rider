...
class MyEditText extends StatelessWidget {
  ...
  MyEditText(
    ...
    this.isCustomOnChangeRequired = false,
    ...
    this.showStarAfterTitle = false,
    this.borderColorOpacity =
        0.38, // opacity of the textfield border, default color black
  }) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        needToShowTitle ? AppWidgets().gapH8() : SizedBox(),
        Visibility(
        ...
        Container(
          ...
          child: TextFormField(
            ...
            onChanged: isCustomOnChangeRequired
                ? onChanged
                : (value) {
                    if (kDebugMode) {
            ...
            decoration: needOnlyLine
                ? InputDecoration(
                    ...
                    isDense: true,
                    labelText: isHintOnly ? hintText : placeholder ?? title,
                    ...
                    enabledBorder: OutlineInputBorder(
                      ...
                      borderSide: BorderSide(
                        ...
                        color: isReadonly && !isDatePicker
                            ...
                            : AppColors.black.withOpacity(borderColorOpacity),
                      ),
                    ),
                    border: OutlineInputBorder(
